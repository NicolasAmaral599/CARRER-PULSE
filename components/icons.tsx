...
export const SparklesIcon: React.FC<{ className?: string }> = ({ className = 'w-5 h-5' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
    ...
    <path d="M10.742 9.972a.75.75 0 00-1.06-.027L6.315 13.31a.75.75 0 01-1.061 0l-1.37-1.37a.75.75 0 010-1.061l3.358-3.358a.75.75 0 00-.028-1.06l-.25-.25a.75.75 0 00-1.06 0l-3.36 3.36a2.25 2.25 0 000 3.18l1.37 1.37a2.25 2.25 0 003.18 0l3.37-3.37a.75.75 0 00.027-1.06l-.25-.25z" />
  </svg>
);
